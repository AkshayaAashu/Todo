...
class EmployeeCreateView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        return redirect(request,"emp-add.html",{"form":form})
...
class SignUpView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            form.save()
            messages.success(request,"account has been registerd successfully")
            
            return redirect("signin")
        messages.error(request,"failed to registered")
        return render(request,"register.html",{"form":form})
...
class SignInView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            unme=form.cleaned_data.get("username")
            pswd=form.cleaned_data.get("password")
            usr=authenticate(request,username=unme,password=pswd)
            if usr:
                login(request,usr)
